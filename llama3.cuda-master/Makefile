...
.PHONY: all train_gpt2 test_gpt2 train_gpt2cu test_gpt2cu train_gpt2fp32cu test_gpt2fp32cu profile_gpt2cu train_llamafp32cu
...
ifeq ($(NVCC),)
    ...
    TARGETS += train_gpt2cu test_gpt2cu train_gpt2fp32cu test_gpt2fp32cu train_llamafp32cu $(NVCC_CUDNN) 
endif
